...
#### 名古屋証券取引所（NSE）
- **URL**: [名古屋証券取引所 単独上場銘柄一覧](https://www.nse.or.jp/listing/single/)
- **取引所コード**: `"N"`
- **説明**: 名古屋証券取引所のみに上場している企業のリスト

#### 福岡証券取引所（FSE）
- **URL**: [福岡証券取引所 単独上場銘柄](https://www.fse.or.jp/listing/single/)
- **取引所コード**: `"F"`
- **説明**: 福岡証券取引所のみに上場している企業のリスト

#### 札幌証券取引所（SSE）
- **URL**: [札幌証券取引所 単独上場銘柄](https://www.sse.or.jp/listing/single/)
- **取引所コード**: `"S"`
- **説明**: 札幌証券取引所のみに上場している企業のリスト
